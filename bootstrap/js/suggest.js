...
function searchSuggest() {
	if (searchReq.readyState == 4 || searchReq.readyState == 0) {
		var str = escape(document.getElementById('txt_material_desc0').value);
		
		searchReq.open("GET", 'po/username?search=' + str, true);
...
function handleSearchSuggest() {
	if (searchReq.readyState == 4) {
		...
		var str1 = document.getElementById('txt_material_desc0');
		//alert(str1);
		var curLeft=0;
		...
		var str2 = document.getElementById('txt_material_desc0');
		var curTop=20;
...
function setSearch(value) {
	document.getElementById('txt_material_desc0').value = value;
